...
- [ ] T004 Add a task checklist item confirming code/comments/config keys are English-only
...
- [ ] TXXX Run `bundle exec jekyll build` for any site-affecting change and record result
...
- Any code/comment/config-key task output must remain in English
- Jekyll-convention and local build-validation tasks are mandatory when site behavior changes
